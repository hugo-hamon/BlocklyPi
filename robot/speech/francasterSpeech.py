...
def answer(a=None):
    ...
    if "qui t'as fabriqué" in a or "qui t'as créer" in a:
            francaster_speak("c'est francas qui m'a dévloppé")
            print("c'est francas qui m'a dévloppé")
            
    if "qui es tu et a quoi tu sert" in a:
            francaster_speak("Je m'appelle francaster. Je suis programmé à répondre à vos question et obéir à vos ordre Je sais ouvrir youtube,google,gmail. Je pourrais vous dire l'heure,prendre des capture d'ecran,rechercher sur wikipedia, je pourrais vous dire aussi la méteo du jours")
    #if "camera" in a or "prend une capture" in a:
