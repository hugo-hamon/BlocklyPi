...
def register_robot_xmlrpc_methods(server: SimpleXMLRPCServer):
    ...
    server.register_function(allbotsController.shift_motor_position, 'robotController.shift_motor_position')
    server.register_function(allbotsController.set_motor_position, 'robotController.set_motor_position')
